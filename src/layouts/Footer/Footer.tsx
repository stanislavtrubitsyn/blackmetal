			...
			>
				...
				>
					{footerLinks.map(link => (
						<ListItem key={link.path} component={Link} to={link.path} sx={listItemStyle}>
				...
				>
					...
					<Box>
						...
						<Typography sx={{ fontSize: '15px', fontWeight: 400, color: '#606060' }}>
					...
					<Box>
						...
						<Typography sx={{ fontSize: '15px', fontWeight: 400, color: '#333333' }}>
